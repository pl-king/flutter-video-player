...
import '../utils.dart';
import 'cupertino_video_progress_bar.dart';
import 'open_iconicIcons.dart';
...
class _CupertinoControlsState extends State<CupertinoControls> {
  ...
  Widget build(BuildContext context) {
    controller = VideoPlayerController.of(context);

    if (_latestValue.hasError) {
      return controller.errorBuilder != null
          ? controller.errorBuilder(
              context,
...
//                  :
  ...
  Widget _buildTopBar(
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          controller.allowFullScreen
              ? _buildExpandButton(
                  backgroundColor, iconColor, barHeight, buttonPadding)
              : Container(),
          Expanded(child: Container()),
          controller.allowMuting
    ...
    return Expanded(
      child: Padding(
        ...
        child: CupertinoVideoProgressBar(
          ...
          colors: controller.cupertinoProgressColors ??
